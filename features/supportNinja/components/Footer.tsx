    ...
    <footer className="bg-[#bfc1b9] py-12 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:block absolute top-24 right-8">
          <a 
            href="/get-started" 
            className="inline-flex items-center px-6 py-3 bg-red-500 text-white font-medium rounded-full hover:bg-red-600 transition-colors duration-200"
          >
            Get started
            <svg 
        ...
        <div className="pt-8 mt-8 border-t border-gray-200 flex flex-col md:flex-row md:justify-between">
          <div className="mb-4 md:mb-0">
            <p className="text-gray-600 text-sm">
              © {year} {companyName}, a registered trademark of Ninja Partners, LLC
            </p>
          </div>
