  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-16 md:flex-row">
      ...
      <div className="relative h-[500px] sm:w-1/2">
        <div className="absolute top-0 left-0 h-45 w-45 overflow-hidden rounded-2xl bg-[#b9bbb4] shadow-lg">
          <img
        ...
        <div className="absolute top-0 left-[37%] flex h-45 w-45 items-center justify-center overflow-hidden rounded-2xl bg-orange-100 shadow-lg md:left-[32%] lg:left-[32%]">
          <img
        ...
        <div className="absolute top-[-7%] right-0 left-[65%] h-45 w-45 overflow-hidden rounded-2xl bg-[#b9bbb4] shadow-lg shadow-[#b9bbb4] md:left-[60%] lg:left-[60%]">
          <img
        ...
        <div className="absolute top-[38%] left-[0] flex h-45 w-45 items-center justify-center overflow-hidden rounded-2xl bg-orange-100 shadow-lg md:top-[40%] lg:top-[40%]">
          <img
        ...
        <div className="absolute top-[45%] left-[28%] h-45 w-45 overflow-hidden rounded-2xl bg-[#b9bbb4] shadow-lg">
          <img
        ...
        <div className="absolute top-[38%] right-0 left-[65%] flex h-45 w-45 items-center justify-center overflow-hidden rounded-2xl bg-orange-100 shadow-lg">
          <img
